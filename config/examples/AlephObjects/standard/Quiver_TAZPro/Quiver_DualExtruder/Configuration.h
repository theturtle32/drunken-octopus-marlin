...
#define E1_DRIVER_TYPE TMC2130 // <-- changed
 ...
 */
#define SWITCHING_NOZZLE // <-- changed
#if ENABLED(SWITCHING_NOZZLE)
  #define SWITCHING_NOZZLE_SERVO_NR 0
  #define SWITCHING_NOZZLE_E1_SERVO_NR 1          // <-- changed: If two servos are used, the index of the second
  #define SWITCHING_NOZZLE_SERVO_ANGLES {55,120}   // <-- changed: Angles for E0, E1 (single servo) or lowered/raised (dual servo)
...
#define HOTEND_OFFSET_X {0,44.58} // <-- changed: (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y {0,0.1}  // <-- changed: (mm) relative Y-offset for each nozzle
#define HOTEND_OFFSET_Z {0,0.01}  // <-- changed: (mm) relative Z-offset for each nozzle
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW // <-- changed
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,500,420} // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0,0,-1.1} // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100,282,20} // <-- changed
...
#define NOZZLE_CLEAN_FEATURE // <-- changed
  ...
  #define NOZZLE_CLEAN_START_POINT {{-17,95,1},{297,95,1}} // <-- changed
  #define NOZZLE_CLEAN_END_POINT   {{-17,25,1},{297,25,1}} // <-- changed
 ...
 */
#define NUM_SERVOS 2 // <-- changed: Note: Servo index starts with 0 for M280-M282 commands

// (ms) Delay before the next move will start, to give the servo time to reach its target angle.
// 300ms is a good value but you can try less delay.
// If the servo can't reach the requested position, increase it.
#define SERVO_DELAY {1000,1000} // <-- changed
...
#define TOOLHEAD_TYPE "DualExtruder" // <-- changed
#define WIPE_SEQUENCE_COMMANDS "M117 Hot end heating...\nM104 S170 T0\nM104 S170 T1\nG28 O1\nM117 Wiping nozzle\nT0\nG1 X-17 Y25 Z10 F4000\nM109 R170 T0\nM109 R170 T1\nG1 Z1\nM114\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 Z15\nM400\nG0 X150 F5000\nT1\nG1 X297 Y25 Z10 F4000\nM109 R170 T0\nM109 R170 T1\nG1 Z1\nM114\nG1 X297 Y25\nG1 X297 Y95\nG1 X297 Y25\nG1 X297 Y95\nG1 X297 Y25\nG1 X297 Y95\nG1 X297 Y25\nG1 X297 Y95\nG1 X297 Y25\nG1 X297 Y95\nG1 X297 Y25\nG1 X297 Y95\nG1 Z15\nM400\nM106 S255 \nG0 X150 F5000\nT0\nM106 S255\nG0 X-10 Y-9\nM109 R160 T0\nM109 R160 T1\nM107" // <-- changed
...
//#define COCOA_PRESS_CHOCOLATE_LEVEL_SENSOR
//#define COCOA_PRESS_CHAMBER_COOLER
//#define COCOA_PRESS_CYCLE_COOLER
//#define COOLER_ON_CYCLE_TIME
//#define COOLER_OFF_CYCLE_TIME