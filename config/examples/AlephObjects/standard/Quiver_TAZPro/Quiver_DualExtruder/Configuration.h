 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0, 0, -1.102} // <-- changed
 ...
 */
#define NUM_SERVOS 2 // <-- changed:  Servo index starts with 0 for M280 command
...
//#define FILAMENT_LOAD_COMMANDS
//#define FILAMENT_UNLOAD_COMMANDS
