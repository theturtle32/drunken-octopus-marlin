 ...
 */
  ...
  //#define THERMAL_PROTECTION_VARIANCE_MONITOR  // <-- changed:  Detect a sensor malfunction preventing temperature updates
#endif
...
#define SENSORLESS_BACKOFF_MM  {5, 5, 0} // <-- changed:  (mm) Backoff from endstops before sensorless homing
...
#define BACKLASH_COMPENSATION // <-- changed
  ...
  #define BACKLASH_DISTANCE_MM {0, 0, 0} // <-- changed:  (mm) One value for each linear axis
