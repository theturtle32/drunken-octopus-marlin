...
#define SENSORLESS_BACKOFF_MM  {5, 5} // <-- changed:  (mm) Backoff from endstops before sensorless homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {2340, 2340, 2340, 102.0} // <-- changed:  (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define EVENT_GCODE_SD_ABORT "G28 Z\nM117 Print aborted." // <-- changed:  G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
//
  ...
  #define AO_EXP1_PINMAP // <-- changed:  AlephObjects CLCD UI EXP1 mapping
...
//#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   1.7 // <-- changed:  (mm/s) Load filament feedrate. This can be pretty fast.
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        1.7 // <-- changed:  (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
