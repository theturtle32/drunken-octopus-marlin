...
#define DISABLE_IDLE_Z    true// <-- changed: Disable if the nozzle could fall onto your printed part!
...
#define DIGIPOT_MOTOR_CURRENT {175,175,240,135,135}   // <-- changed: Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {3000,3000,240,60} // <-- changed: (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G0 X170 Y290 F3000"      // <-- changed: G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
