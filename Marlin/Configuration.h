...
#define TEMP_SENSOR_CHAMBER 7 // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.64 // <-- changed
    #define DEFAULT_Ki   1.22 // <-- changed
    #define DEFAULT_Kd 71.21 // <-- changed
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 30.05 // <-- changed
  #define DEFAULT_bedKi 2.04 // <-- changed
  #define DEFAULT_bedKd 294.88 // <-- changed
...
#define FIL_RUNOUT_PIN 29 // <-- changed
//#define SERVO0_PIN
