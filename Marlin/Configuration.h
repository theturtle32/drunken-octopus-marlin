...
#define Z2_DRIVER_TYPE TMC2130 // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {37.83, 37.93, -4.6} // <-- changed
...
#define SHORT_BUILD_VERSION "2.x.x (6791b418)" // <-- changed
...
#define TOUCH_UI_VERSION "Release: 1 (" __DATE__  ")\nMarlin " SHORT_BUILD_VERSION // <-- changed
