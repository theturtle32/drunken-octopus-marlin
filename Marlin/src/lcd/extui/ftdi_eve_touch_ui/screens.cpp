...
SCREEN_TABLE {
  ...
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_STATUS_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_PRINTING_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_TOOLS_MENU)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_SETTINGS_MENU)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_MOVE_MENU)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_MOVE_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_LEVELING_MENU)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_HOTEND_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_COOLDOWN_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_ADV_SETTINGS_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_FILES_SCREEN)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_CONFIRM_START_PRINT)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_CONFIRM_MANUAL_LEVEL)
  DECL_SCREEN_IF_INCLUDED(SYNDAVER_LEVEL_ENDSTOP_STATE_SCREEN)
};
